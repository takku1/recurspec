...
### 4. Incomplete-Work Gate (`docs/open-work.md`)
Maintain **one** checklist: `docs/open-work.md` (statuses: `ready` | `blocked` | `deferred` | `research` | `done`). Do not create parallel readiness or fog lists. Archive first if absorbing `findings/` or `bugs/` notes (see `docs/archive/README.md`).
